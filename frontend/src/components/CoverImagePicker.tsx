  ...
  return (
    <div className="flex gap-3">
      <div
        ...
        className={`relative shrink-0 overflow-hidden rounded-lg border border-dashed border-slate-300 bg-slate-100 outline-none transition-colors focus:border-indigo-400 focus:ring-2 focus:ring-indigo-500/30 dark:border-slate-700 dark:bg-slate-800 ${dims}`}
      >
        {showImage ? (
          <img
            src={value}
