// Consistent 1.75px-stroke outline icon set (Lucide-style paths) so nothing
// in the UI relies on emoji for structural meaning.
...
export function ImageOffIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="m8.5 10 2.5 3 2-2 3.5 4.5" />
...
export function SparkleIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 2.5c.6 3.4 2 6.1 4.5 8.1S21 14 21 14s-3.9.6-6.5 2.5S12 21.5 12 21.5s-.6-3.4-2.5-5c-2.5-2-6.5-2.5-6.5-2.5s4-.9 6.5-3S12 2.5 12 2.5Z" />
    </svg>
  );
}
